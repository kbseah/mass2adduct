#' Calculate correlations of pairs of mass peaks from MSI data (for loop version)
#'
...
corrPairsMSIloop <- function(d, pairs, p.val=0.05, method="pearson", alternative="greater", ...) UseMethod("corrPairsMSIloop")
