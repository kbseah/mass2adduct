#' Calculate correlations of pairs of mass peaks from MSI data (parallel version)
#'
...
#'
#' This is the parallelized version using forking processes - usable on systems
...
#' @param ncores integer; Number of cores to use (default: detected cores - 1)
#'
...
corrPairsMSIparallel <- function(d,
                                 pairs,
                                 p.val=0.05,
                                 method="pearson",
                                 alternative="greater",
                                 ncores=parallel::detectCores() - 1,
                                 ...) UseMethod("corrPairsMSIparallel")
